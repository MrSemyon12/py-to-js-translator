...
class Grammar:
    ...
    def __init__(self):
        self.LETTER = Rule("LETTER", SyntaxUnit("A"), SyntaxUnit("B"), SyntaxUnit("C"), SyntaxUnit("D"),
                           SyntaxUnit("E"), SyntaxUnit("F"), SyntaxUnit(
                               "G"), SyntaxUnit("H"), SyntaxUnit("I"),
                           SyntaxUnit("J"), SyntaxUnit("K"), SyntaxUnit(
                               "L"), SyntaxUnit("M"), SyntaxUnit("N"),
                           SyntaxUnit("O"), SyntaxUnit("P"), SyntaxUnit(
                               "Q"), SyntaxUnit("R"), SyntaxUnit("S"),
                           SyntaxUnit("T"), SyntaxUnit("U"), SyntaxUnit(
                               "V"), SyntaxUnit("W"), SyntaxUnit("X"),
                           SyntaxUnit("Y"), SyntaxUnit("Z"),
                           SyntaxUnit("a"), SyntaxUnit("b"), SyntaxUnit(
                               "c"), SyntaxUnit("d"), SyntaxUnit("e"),
                           SyntaxUnit("f"), SyntaxUnit("g"), SyntaxUnit(
                               "h"), SyntaxUnit("i"), SyntaxUnit("j"),
                           SyntaxUnit("k"), SyntaxUnit("l"), SyntaxUnit(
                               "m"), SyntaxUnit("n"), SyntaxUnit("o"),
                           SyntaxUnit("p"), SyntaxUnit("q"), SyntaxUnit(
                               "r"), SyntaxUnit("s"), SyntaxUnit("t"),
                           SyntaxUnit("u"), SyntaxUnit("v"), SyntaxUnit(
                               "w"), SyntaxUnit("x"), SyntaxUnit("y"),
                           SyntaxUnit("z"))
        ...
        self.DIGIT = Rule("DIGIT", SyntaxUnit(
            "0"), SyntaxUnit(self.NOT_NULL_DIGIT))
        ...
        self.STRING_TYPE = Rule(
            "STRING_TYPE", SyntaxUnit("\"", self.STRING, "\""))
        ...
        self.INTEGER = Rule("INTEGER", SyntaxUnit(
            self.NUM), SyntaxUnit("-", self.NUM))
        ...
        self.LOGICAL_OPERATOR = Rule(
            "LOGICAL_OPERATOR", SyntaxUnit("or"), SyntaxUnit("and"))

        self.ADDICTIVE_OPERATION = Rule(
            "ADDICTIVE_OPERATION", SyntaxUnit("+"), SyntaxUnit("-"))

        self.MULTIPLICATIVE_OPERATION = Rule(
            "MULTIPLICATIVE_OPERATION", SyntaxUnit("*"), SyntaxUnit("/"))
        ...
        self.DIGIT_VAR.add(SyntaxUnit(self.DIGIT, self.DIGIT_VAR),
                           SyntaxUnit(self.DIGIT, self.VARIABLE))
        self.VARIABLE.add(SyntaxUnit("_", self.VARIABLE),
                          SyntaxUnit(self.LETTER, self.VARIABLE))
        ...
        self.FLOAT = Rule("FLOAT", SyntaxUnit(self.REAL_NUMBER),
                          SyntaxUnit("-", self.REAL_NUMBER))
        ...
        self.MULTIPLIER = Rule("MULTIPLIER", SyntaxUnit(
            self.RELATION_EXPR), SyntaxUnit("(", self.RELATION_EXPR, ")"))
        self.SUMMAND = Rule("SUMMAND", SyntaxUnit(self.MULTIPLIER))
        self.SUMMAND.add(SyntaxUnit(
            self.SUMMAND, self.MULTIPLICATIVE_OPERATION, self.SUMMAND))

        self.EXPRESSION = Rule("EXPRESSION", SyntaxUnit(self.SUMMAND))
        self.EXPRESSION.add(SyntaxUnit(
            self.EXPRESSION, self.ADDICTIVE_OPERATION, self.EXPRESSION))
        self.RELATION_EXPR.add(SyntaxUnit(
            self.EXPRESSION, self.RELATIONS, self.EXPRESSION))
        ...
        self.EXPRESSION.add(SyntaxUnit("math.cos", "(", self.VALUE, ")"), SyntaxUnit("math.sin", "(", self.VALUE, ")"),
                            SyntaxUnit("math.sqrt", "(", self.VALUE, ")"), SyntaxUnit(
                                "abs", "(", self.VALUE, ")"),
        ...
        self.COMPOUND_OPERATOR = Rule(
            "COMPOUND_OPERATOR", SyntaxUnit(self.VARIABLE_DECLARATION))
        ...
        self.INTERNAL_OPERATOR = Rule(
            "INTERNAL_OPERATOR", SyntaxUnit(self.T, self.COMPOUND_OPERATOR))
        self.INTERNAL_OPERATOR.add(SyntaxUnit(
            self.T, self.COMPOUND_OPERATOR, self.N, self.INTERNAL_OPERATOR))
        ...
        self.COMPOUND_OPERATOR.add(SyntaxUnit(
            self.CONDITIONAL_OPERATOR), SyntaxUnit(self.WHILE))
        ...
        self.PROGRAMM.add(SyntaxUnit(
            self.COMPOUND_OPERATOR, self.N, self.PROGRAMM))
