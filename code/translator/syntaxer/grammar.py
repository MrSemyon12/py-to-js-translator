...
class Grammar:
    ...
    def __init__(self):
        ...
        self.INTERNAL_OPERATOR = Rule(
            "INTERNAL_OPERATOR", SyntaxUnit(self.PROGRAMM))
        ...
        self.CONDITIONAL_OPERATOR = Rule("CONDITIONAL_OPERATOR", SyntaxUnit("if", self.CONDITIONAL_EXPRESSION, ":", "{", self.INTERNAL_OPERATOR, "}"),
